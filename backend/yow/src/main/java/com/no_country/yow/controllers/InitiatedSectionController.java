...
public class InitiatedSectionController {
    ...
    //private ContactService beanContact;

    private VirtualWalletService beanVirtualWallet;

    public InitiatedSectionController(PersonService personService, ContactService contactService, VirtualWalletService virtualWalletService){
        this.beanPerson  = personService;
        //this.beanContact = contactService;
