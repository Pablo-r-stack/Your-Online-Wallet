...
// Configura la cadena de filtros de seguridad
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationManager authenticationManager) throws Exception {
        ...
        log.info("entro en la seguridad");
                .csrf(csrf -> csrf.disable()) // Deshabilita la protección CSRF La vamos a deshabilitar por que estamos trabajando con jwt
                .authorizeHttpRequests(requests -> requests // Configura las reglas de autorización para las solicitudes HTTP
